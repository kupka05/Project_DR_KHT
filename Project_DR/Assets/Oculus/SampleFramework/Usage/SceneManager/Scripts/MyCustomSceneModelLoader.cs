...
public class MyCustomSceneModelLoader : OVRSceneModelLoader
{
    IEnumerator DelayedLoad()
    {
        ...
        GFunc.Log("[MyCustomSceneLoader] calling OVRSceneManager.LoadSceneModel() delayed by 1 second");
    ...
    protected override void OnNoSceneModelToLoad()
    {
        ...
        GFunc.Log("[MyCustomSceneLoader] There is no scene to load, but we don't want to trigger scene capture.");
    }
}
