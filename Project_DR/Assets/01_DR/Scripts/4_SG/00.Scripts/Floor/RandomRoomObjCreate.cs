...
{       // 방 오브젝트를 깔아주는 Class
    ...
    /// <param name="_isFixPosition"> 고정된 위치에 생성되어야하는지 bool값 </param>
    protected void SpawnRoomObj(StringBuilder _spawnItemName,bool _isFixPosition)
    {
    ...
    /// /// <param name="_isFixPosition"> 고정된 위치에 생성되어야하는지 bool값 </param>
    private void PositionSetting(StringBuilder _spawnItemName,bool _isFixPosition)
    {
